...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('tempadmin/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')}} ">
<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('css/pnotify.custom.min.css') }}">
<link rel="stylesheet" href="{{ asset('tempadmin/bower_components/select2/dist/css/select2.min.css') }}">
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Dating</b>App</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset('tempadmin/dist/img/user3-128x128.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset('tempadmin/dist/img/user4-128x128.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('tempadmin/dist/img/user2-160x160.jpg')}}" class="user-image" alt="User Image">
          ...
          <li>
            <a href="{{route('sign-out')}}"><i class="fa fa-sign-out"></i> &nbsp;Logout</a>
          </li>
        </ul>
      </div>
