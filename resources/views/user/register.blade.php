...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#mainNav" data-offset="70">
        ...
        <!--================Latest News Area =================-->
        <section class="latest_news_area p_120" style="background-image:url('{{ asset('temp/img/banner/smiling.jpg') }}');background-position: center; padding-bottom: 30px !important;">
            <div class="container">
                                ...
                                <div class="col-sm-8" style="display: inline-flex;" id="radio_box">
                                      <div  class="col-md-4 col-md-offset-right-2">
                                        <input type="radio" name="optradio" value="male">
                                          <label class=""><img  class="" src="{{ asset("avatars/man-big.png") }}"></label>
                                      </div>
                                      <div class="col-md-4 col-md-offset-right-2">
                                          <input type="radio" name="optradio" value="female">
                                          <label class="radio-inline"><img class=""  src="{{ asset("avatars/woman-big.png") }}"></label>
