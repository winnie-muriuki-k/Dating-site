            ...
            <div class="container-fluid bg-light" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="width: 100%;">
                        ...
                        <input type="email" name="email"  class="form-control" value="<?php echo e(Auth::user()->email); ?>" id="Email">
                        <input type="hidden" name="user_id"  class="form-control" value="<?php echo e(Auth::user()->id); ?>" id="user_id">
                        <br>
...
<?php /* C:\Users\WYN\winnie-project\resources\views/user/settings.blade.php */ ?>