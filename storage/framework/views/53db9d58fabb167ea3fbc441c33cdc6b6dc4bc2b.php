...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#mainNav" data-offset="70">
        ...
        <!--================Latest News Area =================-->
        <section class="latest_news_area p_120" style="background-image:url('<?php echo e(asset('temp/img/banner/smiling.jpg')); ?>');background-position: center;">
                        ...
                        <h3>Sign In</h3>
                            <form id="login-us-form" onsubmit="return SignUp()">
                              ...
                              <div class="row" style="margin-top: 2%;">
                                  <a href="<?php echo e(route('user-register')); ?>" title="register for a new account."> Create Account </a> 
                                  <span style="margin-left: 1%;margin-right: 1%;">||</span>
                                  <a href="<?php echo e(route('user-password-reset')); ?>" title="Forgot account password, follow this link.">Recover account password ? </a>
...
<?php /* C:\Users\WYN\winnie-project\resources\views/user/login.blade.php */ ?>