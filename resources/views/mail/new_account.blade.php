...
<table width="100%" height="750" cellpadding="0" cellspacing="0" border="0" style="background: #fff; background-size: cover;color:#121212;padding:0px;margin:0px;width:100%;font-family: 'Source Sans Pro', sans-serif;font-weight: 400;line-height:1.5">
  <tbody>
    <tr>
      <td>
            ...
            <td align="center" style="background: #ffffff; box-shadow: 0 9px 18px 0 rgba(0,0,0,.3), 0 2px 6px 0 rgba(0,0,0,.3);border-radius: 16px;padding:30px;margin:0px;" width="400">
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tbody>
                  <tr>
                    <td align="center">
                      <h4 style="margin: 0; padding: 0 0 20px;color: #099026;font-size:40px;font-family: 'Oxygen', sans-serif;font-weight: 700;">Dating App</h4>
                    </td>
                  </tr>
                  <tr>
                    <td align="center">
                      <p style="color: #666666;font-size: 16px;margin: 0; padding: 10px 0 10px;">Your account creation was successful!</p>
                    </td>
                  </tr>
                  <tr>
                    <td align="center">
                      <h1 style="font-size: 30px;font-family: 'Oxygen', sans-serif;font-weight: 400;margin:0; padding:20px 0 10px;">The Team</h1>
                    </td>
                  </tr>
                </tbody>
              </table>
