            ...
            <div class="box-body">
               <table style="width: 100%" id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th>{{++$i}}</th>
                        <td>{{ !empty($country->name) ? $country->name : 'Not set' }}</td>
                        <td>{{ !empty($country->created_at) ? $country->created_at : 'Not set' }}</td>
                        <td>
                          ...
                          <button class="btn btn-danger btn-xs" type="button" title="delete country" onclick="deleteCountry('{{$country->id}}')">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <form class="form-horizontal" method="post" action="{{route('process-country')}}">
              {{csrf_field()}}
              <div class="box-body">
