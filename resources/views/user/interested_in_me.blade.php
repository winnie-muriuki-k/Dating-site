...
<section class="latest_news_area p_120 " style="padding-bottom: 0px !important; background: #ded0e4 !important;">
    <div class="l_news_item col-md-10 main-holder">
        <div class="row">
            <div class="col-md-8">
                <h4 style="color: #403a3a;">Who's interested in you</h4>
            </div>
            <div class="col-md-4">
                <h4 style="color: #403a3a;  color:black; font-size: 15px;">Related Searches <u><a href="{{route('interests',['id'=>Auth::user()->id])}}" class="">My Interests</a> </u></h4>
            </div>
        </div>
